...
// Compatible with Quantumult X task script.
//
// Quantumult X argument examples:
  ...
  function request(method, path, headers, body, callback) {
    function run(attempt) {
      ...
      $task.fetch(options).then(
        function (response) {
          var data = response && response.body !== undefined ? response.body : "";
